...
NotesManager.prototype.handleOpenHelp = function(evt) {
	if (this.!$help.is(":visible")) {
		...
		// dont forget to add the this keyword to your function calls 
		this.showHelp();
	}
};
...
// 	// i starts at 0
// 	// dont go go past the total length of data
// 	// irritarate through the data
// 	for (var i = 0; i < data.length; i++) {

// 		// push the data to the notes object
...
// calling load data function with the data 
